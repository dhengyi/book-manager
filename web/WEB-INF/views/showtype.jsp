...
<div id="main">
    <div id="main_head"><a href="${pageContext.request.contextPath}/auth/">首页</a><i class="fa fa-lg fa-angle-right"></i><a
            href="${pageContext.request.contextPath}/auth/tags">全部标签</a>
    ...
    <div id="index_pingination">
        <ul class="pagination">
            ...
            <c:if test="${pageInfo.currentPage != 1 && pageInfo.totalPage != 0}">
                <li><a href="${pageContext.request.contextPath}/auth/types?tag=${labelId}">首页</a></li>
                <li>
                    <a href="${pageContext.request.contextPath}/auth/types?tag=${labelId}&page=${pageInfo.currentPage-1}">&laquo;</a>
                </li>
            </c:if>
            ...
            <c:if test="${pageInfo.currentPage >= 6}">
                <li>
                    <a href="${pageContext.request.contextPath}/auth/types?tag=${labelId}&page=${returnPreFivePage}">[...]</a>
                </li>
            </c:if>
            ...
            <c:forEach varStatus="i" begin="${ELPageValue+1}"
                ...
                <c:if test="${i.current <= pageInfo.totalPage}">
                    ...
                    <c:if test="${i.current != pageInfo.currentPage}">
                        <li>
                            <a href="${pageContext.request.contextPath}/auth/types?tag=${labelId}&page=${i.current}">${i.current}</a>
                        </li>
                    </c:if>
                </c:if>
            </c:forEach>
            ...
            <c:if test="${pageInfo.currentPage < isOneOfNextFivePage && pageInfo.totalPage >= 6}">
                <li>
                    <a href="${pageContext.request.contextPath}/auth/types?tag=${labelId}&page=${reachNextFivePage}">[...]</a>
                </li>
            </c:if>
            ...
            <c:if test="${pageInfo.currentPage != pageInfo.totalPage && pageInfo.totalPage != 1 && pageInfo.totalPage != 0}">
                <li>
                    <a href="${pageContext.request.contextPath}/auth/types?tag=${labelId}&page=${pageInfo.currentPage+1}">&raquo;</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/auth/types?tag=${labelId}&page=${pageInfo.totalPage}">尾页</a>
                </li>
            </c:if>
        </ul>
    </div>
